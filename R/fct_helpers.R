#' helpers
#'
#' @description calculate pathways
#'
#' @return list
#'
#' @noRd
...
# result_list <- list(scenario1 = scenario1())
  ...
  if (exists("scenario1_vars") & length(displayed_scenarios())>=1) {
  ...
  out_list <- list(
    params_scenario1 = if(exists("scenario1_vars") & length(displayed_scenarios())>=1) params_scenario1 else NULL,
    ...
    out_scenario1 = if(exists("scenario1_vars") & length(displayed_scenarios())>=1) out_scenario1 else NULL,
