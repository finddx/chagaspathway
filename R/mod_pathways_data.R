      ...
      card(
        ...
        card_body(
          layout_column_wrap(
            ...
            numericInput(ns("ltfu"), label=HTML("<b> LTFU (0-100%) </b> </br> Expected LTFU following patient or sample referral from low complexity to high complexity facility."), min=0, max=1, value=0.5, width="100%"),
