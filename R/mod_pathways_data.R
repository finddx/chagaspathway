...
mod_pathways_data_ui <- function(id){
  ...
  tagList(
    fluidRow(
      ...
      column(3, numericInput(ns("link_treatment_l"), label=HTML("<b> Linkage to treatment (0-100%) </b> </br> Expected linkage to treatment if final diagnosis is made after testing at low complexity facility."), min=0, max=100, value=NULL, width="100%")),
      column(3, numericInput(ns("link_treatment_h"), label=HTML("<b> Linkage to treatment (0-100%) </b> </br> Expected linkage to treatment if final diagnosis is made after testing at high complexity facility"), min=0, max=100, value=NULL, width="100%")),
