...
We welcome feedback on the application, including suggestions for adaptations to the model or the online interface, through <a href="https://forms.gle/h584XtkKmsATiCUf7" target="_blank">our anonymous survey</a>. You may answer as many or as few questions as you wish, and you may provide feedback more than once.
...
![Parallel testing algorithm](../img/parallel.png){#fig-parallel .fig fig-align="center"}
...
![Serial testing with confirmatory testing of positive tests only.](../img/serial-pos.png){#fig-serialpos .fig fig-align="center"}
...
![Serial testing with full confirmatory testing.](../img/serial-full.png){#fig-serialfull .fig fig-align="center"}
