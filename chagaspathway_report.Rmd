...
for (i in 1:num_scenarios) {
   ...
   #  cat("\n")
   # htmltools::tag(params[[paste0("fig_diagram_scenarios", i)]])
   #  cat("\n")
     # plotlist[[i]] <- list(
    ...
    # cat("</br>"),
      # params[[paste0("values_box_scenarios", i)]])
      # cat("</br>"),
    htmlwidgets::widgetList(params[[paste0("fig_diagram_scenarios", i)]])
      # print(htmltools::tagList(params[[paste0("fig_diagram_scenarios", i)]]))
    ...
    cat("</div>")
        ...
        # plot_ppv = params[[paste0("plot_ppv_scenarios", i)]],
        # plot_npv = params[[paste0("plot_npv_scenarios", i)]],
        # plot_cpc = params[[paste0("plot_cpc_scenarios", i)]]
    # )
